...
const Dialoguebox = () => {
  const { DialougeText, BoxStatus } = useContext(DialogueContext);

  const [BoxDisplay, showboxDisplay] = useState("block");

  return (
    <div
      className={` ${BoxStatus} w-full h-screen fixed bg-black z-50 top-0 left-0 flex items-center justify-center`}
    >
